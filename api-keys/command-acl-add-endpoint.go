...
var commandAclAddEndpoint cli.Command = cli.Command{
	Name:        "acl-add-endpoint",
	ArgsUsage:   "",
	Description: "This operation adds an endpoint(s) on the key collection ACL",
	HideHelp:    true,
	Action:      callAclAddEndpoint,
	Flags: []cli.Flag{
		cli.StringFlag{
			Name:  "collection",
...
func callAclAddEndpoint(c *cli.Context) error {
	err := initConfig(c)
	if err != nil {
